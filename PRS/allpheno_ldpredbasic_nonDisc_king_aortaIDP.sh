#!/bin/bash
#SBATCH --job-name=ldp2AorIDP_nonDisc_king
...
#arguments related to the pipeline, sbigsnprenv_2025pecific to LDPred2 (ldpred2_basic_ext_fullUKB.r)
input="${input:-/group/glastonbury/soumick/PRS/inputs/F20208_IDPs/lw_gw_indep/aorta/gwcond_plus_plink_maf1p_geno10p_caucasian_prune_250_5_r0p5_ukbb_autosomes_mac100_info0p4.bgen}"
pheno_SNPs="${pheno_SNPs:-/group/glastonbury/soumick/PRS/inputs/F20208_IDPs/lw_gw_indep/aorta/lw_SNPs_gwcond_plus_plink_maf1p_geno10p_caucasian_prune_250_5_r0p5_ukbb_autosomes_mac100_info0p4}"

# subs2include="${subs2include:-/group/glastonbury/soumick/PRS/inputs/F20208_IDPs/lw_gw_indep/aorta/king_cutoff_0p0625_nonDisc_gwcond_plus_plink_maf1p_geno10p_caucasian_prune_250_5_r0p5_ukbb_autosomes_mac100_info0p4.king.cutoff.in.id}" #TODO
subs2include="${subs2include:-/group/glastonbury/soumick/PRS/inputs/F20208v3_DiffAE_select_latents_r80_discov_INF30/2_king_cutoff_0p0625_nonDisc_cond_plus_plink_maf1p_geno10p_caucasian_prune_250_5_r0p5_ukbb_autosomes_mac100_info0p4.king.cutoff.in.id}" #TODO

output_prefix="${output_prefix:-/group/glastonbury/soumick/PRS/LDPred2/F20208v3_DiffAE/nonDisc/IDPs/aorta/run_ext_basic_DiffAEking0p0625_lw_gw_indep_FiltMAF_}"

ext_sumstats_root="${ext_sumstats_root:-/group/glastonbury/GWAS/CarPheno/6thbasket_aorta_phenos/Qntl_WBRIT_6thbasket_aorta_phenos/Qntl_WBRIT_6thbasket_aorta_phenos/results/gwas}"
...
echo "About to execute the Rscript with the following command:"
echo "Rscript $programme \
        --input $input \
...
echo "Rscript execution completed."
