...
#SBATCH --partition=cpu-interactive      # type of node we are using (cpuq or gpuq, this is not meant for interactive nodes)
...
plink2 \
    ...
    --export vcf bgz --out /group/glastonbury/soumick/PRS/inputs/F20208v3_DiffAE_select_latents_r80_discov_INF30/VCF_cond_plus_plink_maf1p_geno10p_caucasian_prune_250_5_r0p5_ukbb_autosomes_mac100_info0p4 --threads 32