...
plink2 \
    ...
    --maf 0.01 --geno 0.1 \
    --indep-pairwise 250 5 0.5 \
    --out /group/glastonbury/soumick/PRS/inputs/common/prunedUKBB/plink_maf1p_geno10p_caucasian_prune_250_5_r0p5_ukbb_autosomes_mac100 \
    --threads 64
