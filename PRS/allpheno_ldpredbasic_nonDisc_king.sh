...
#general arguments
root="${root:-/home/soumick.chatterjee/Codes/GitHub/prs_pipeline/}"
programme="${programme:-scripts/ldpred2_basic_ext_fullUKB.r}"
conda="${conda:-/ssu/gassu/conda_envs/bigsnprenv_1911}"
...
ext_col_sumstats="${ext_col_sumstats:-/home/soumick.chatterjee/Codes/GitLab/tricorder/PRS/davide_fede/sumcols_UKBB_regenie.json}"
filtMAF="${filtMAF:-1}"
threads="${threads:-5}"
