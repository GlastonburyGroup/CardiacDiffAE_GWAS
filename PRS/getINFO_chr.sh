...
/group/glastonbury/soumick/bin/bgex/bgex \
    --bgens /group/glastonbury/soumick/MyCodes/GitLab/tricorder/PRS/bgen_lst.txt \
    --samples /processing_data/shared_datasets/ukbiobank/raw_data/genotypes/imputed/ukb22828_c1_b0_v3_s487202.sample \
    --info \
    --min-info 0.4 \
    --out /group/glastonbury/soumick/PRS/inputs/common/bgex_chrs_nopar/varinfo_ukb22828_b0_v3_s487202