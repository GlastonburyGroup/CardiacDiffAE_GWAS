...
input="${input:-/group/glastonbury/soumick/PRS/inputs/F20208v3_DiffAE_select_latents_r80_discov_INF30/lw_gw_indep/gwcond_plus_plink_maf1p_geno10p_caucasian_prune_250_5_r0p5_ukbb_autosomes_mac100_info0p4.bgen}"
pheno_SNPs="${pheno_SNPs:-/group/glastonbury/soumick/PRS/inputs/F20208v3_DiffAE_select_latents_r80_discov_INF30/lw_gw_indep/lw_SNPs_gwcond_plus_plink_maf1p_geno10p_caucasian_prune_250_5_r0p5_ukbb_autosomes_mac100_info0p4}"

#originally we used this. But, now we are replacing with the one consistent with the whole pipeline
# subs2include="${subs2include:-/group/glastonbury/soumick/PRS/inputs/F20208v3_DiffAE_select_latents_r80_discov_INF30/2_king_cutoff_0p0625_nonDisc_cond_plus_plink_maf1p_geno10p_caucasian_prune_250_5_r0p5_ukbb_autosomes_mac100_info0p4.king.cutoff.in.id}"
subs2include="${subs2include:-/group/glastonbury/soumick/PRS/inputs/F20208v3_DiffAE_select_latents_r80_discov_INF30/lw_gw_indep/king_cutoff_0p0625_nonDisc_gwcond_plus_plink_maf1p_geno10p_caucasian_prune_250_5_r0p5_ukbb_autosomes_mac100_info0p4.king.cutoff.in.id}"

output_prefix="${output_prefix:-/group/glastonbury/soumick/PRS/LDPred2/F20208v3_DiffAE/nonDisc/run_ext_basic_king0p0625_lw_gw_indep_FiltMAF_}"

ext_sumstats_root="${ext_sumstats_root:-/group/glastonbury/GWAS/F20208v3_DiffAE/select_latents_r80/nNs_Qntl_INF30_DiffAE128_5Sd_r80_discov_fullDSV3/nNs_Qntl_INF30_DiffAE128_5Sd_r80_discov_fullDSV3/nNs_Qntl_INF30_DiffAE128_5Sd_r80_discov_fullDSV3/results/gwas}"
