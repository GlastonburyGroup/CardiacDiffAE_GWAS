...
plink2 \
    ...
    --keep /group/glastonbury/soumick/PRS/inputs/F20208v3_DiffAE_select_latents_r80_replic_INF30_caucasian/subIDs.txt \
    --king-cutoff 0.0625 \
    --out /group/glastonbury/soumick/PRS/inputs/F20208v3_DiffAE_select_latents_r80_replic_INF30_caucasian/king_cutoff_0p0625_cond_plus_plink_maf1p_geno10p_caucasian_prune_250_5_r0p5_ukbb_autosomes_mac100_info0p4 \
    --threads 64