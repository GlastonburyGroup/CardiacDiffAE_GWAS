...
def getARGSParser():
    ...
    parser.add_argument('--path4res', type=str, default="/group/glastonbury/soumick/GWAS/merged_latents_models/latents", help='Path where the merged stuff will be saved.')
