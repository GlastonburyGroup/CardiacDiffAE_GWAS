...
def getARGSParser():
    ...
    parser.add_argument('--trainIDs', type=str, default="F20208_heart_1Ses_time2slc_MskCrop128_mulseed_1701_3D_128fold0_prec16-mixed_DiffAE,\
                        F20208_heart_1Ses_time2slc_MskCrop128_mulseed_1993_3D_128fold0_prec16-mixed_DiffAE,\
                        F20208_heart_1Ses_time2slc_MskCrop128_mulseed_42_3D_128fold0_prec16-mixed_DiffAE,\
                        F20208_heart_1Ses_time2slc_MskCrop128_mulseed_1994_3D_128fold0_prec16-mixed_DiffAE,\
                        F20208_heart_1Ses_time2slc_MskCrop128_mulseed_2023_3D_128fold0_prec16-mixed_DiffAE", help='Coma-seperated list of trainIDs to merge')
    ...
    parser.add_argument("--train_root", type=str, default="/project/ukbblatent/Out/Results", help="Root folder where the trainings are stored")
    ...
    parser.add_argument("--gwas_folder", type=str, default="GWAS_fullDSV2_noNoise", help="Folder inside train_root/trainID where the processed_raw.tsv is available (output of GWAS engager).")
    
    parser.add_argument('--path4res', type=str, default="/group/glastonbury/soumick/GWAS/shortlisted_latents_models/posthoc", help='Path where the merged stuff will be saved.')
    parser.add_argument('--save_tag', type=str, default="5Seeds_f0_DiffAEFP16_128_Crop3D", help='Tag to identify this merge')
    
    parser.add_argument('--similarity_measure', type=float, default=-1, help='-1: No filtering (keep everything), 0: Cosine similarity, 1: Mahalanobis distance. 2: R-score. [Default: 0]')
...
if __name__ == "__main__":
    ...
    match args.similarity_measure:
        case -1:
            args.path4res = f"{args.path4res}_nofiltering"
        case 0:
    ...
    if args.similarity_measure == -1:
        # No filtering - include all columns from all trainings
        print("No filtering mode: keeping all latents from all trainings")
    ...
    if args.similarity_measure == -1:
        # No filtering mode - use all columns
