...
parser.add_argument("--in_path", help="path to the zip files", default=r"/processing_data/shared_datasets/ukbiobank/raw_data/phenotypes/imaging/F20204_Liver_Imaging_T1_ShMoLLI_DICOM")
parser.add_argument("--out_path", help="path to store the HDF5 file", default=r"/group/glastonbury/soumick/dataset/ukbbH5s/prova_F20209_Short_axis_heart_images_DICOM_H5")
