...
dir_unsorted="${dir_unsorted:-0}"
fID="${fID:-}"
fDirName="${fDirName:-F20208_Long_axis_heart_images_DICOM}"
include="${include:-}"
filetag="${filetag:-}"
ds_names_present="${ds_names_present:-primary_LAX_4Ch_transverse_0}"
argsH5="${argsH5:-}"
...
create_toydataset="${create_toydataset:-0}"
