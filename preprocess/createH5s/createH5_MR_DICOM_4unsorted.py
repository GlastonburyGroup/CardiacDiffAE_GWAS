...
parser.add_argument("--in_path", help="path to the zip files", default=r"/processing_data/shared_datasets/ukbiobank/recent_downloads/soumick/ukb675605_seventh_basket_bulk/bulkfiles")
parser.add_argument("--out_path", help="path to store the HDF5 file", default=r"/scratch/glastonbury/datasets/ukbbH5s/_tmp_newV3")
...
with open("/group/glastonbury/soumick/MyCodes/GitLab/tricorder/preprocess/createH5s/meta.yaml", 'r') as f:
