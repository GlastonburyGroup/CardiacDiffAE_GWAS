...
parser.add_argument("--in_path", help="path to the zip files", default=r"/processing_data/shared_datasets/ukbiobank/raw_data/phenotypes/imaging")
parser.add_argument("--out_path", help="path to store the HDF5 file", default=r"/group/glastonbury/soumick/dataset/ukbbH5s")
