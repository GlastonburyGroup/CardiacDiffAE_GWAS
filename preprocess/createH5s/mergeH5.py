...
parser.add_argument("--new_root", help="path to the zip files", default=r"/scratch/glastonbury/datasets/temp_ukbbH5s/_tmp_newV2")
parser.add_argument("--original_root", help="path to store the HDF5 file", default=r"/scratch/glastonbury/datasets/ukbbH5s")
parser.add_argument("--out_root", help="path to store the HDF5 file", default=r"/scratch/glastonbury/datasets/ukbbH5s")

parser.add_argument("--originalV", help="What's the version tag of the original DS", default="v1")
parser.add_argument("--newV", help="What's the version tag of newly downloaded DS", default="OnlyV2")
parser.add_argument("--outV", help="What's the version of the output DS", default="v2")
