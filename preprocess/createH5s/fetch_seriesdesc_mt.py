...
parser.add_argument("--in_path", help="path to the zip files", default=r"/processing_data/shared_datasets/ukbiobank/raw_data/phenotypes/imaging/F20209_Short_axis_heart_images_DICOM")
