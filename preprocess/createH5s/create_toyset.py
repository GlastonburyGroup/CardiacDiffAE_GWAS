...
parser.add_argument("--in_path", help="path to the zip files", default=r"/scratch/soumick.chatterjee/dataset/ukbbH5s/F20201_Dixon_technique_internal_fat_DICOM_RECOHPipe_H5")
parser.add_argument("--out_path", help="path to store the HDF5 file", default=r"/group/glastonbury/soumick/toysets")
