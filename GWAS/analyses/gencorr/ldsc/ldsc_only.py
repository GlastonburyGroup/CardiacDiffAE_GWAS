...
def getARGSParser(parents=None):     
    ...
    parser.add_argument('--path2gwasout', type=str, default="/group/glastonbury/GWAS/F20208v3_DiffAE/select_latents_r80/nNs_Qntl_INF30_DiffAE128_5Sd_r80_discov_fullDSV3/nNs_Qntl_INF30_DiffAE128_5Sd_r80_discov_fullDSV3/nNs_Qntl_INF30_DiffAE128_5Sd_r80_discov_fullDSV3/results/gwas", help='Location where the GWAS outputs are storred')
    ...
    parser.add_argument('--n_workers', type=int, default=32, help='Number of workers to use for parallelisation. Set it to -1 for using all available CPUs')
