...
def getARGSParser():
    ...
    parser.add_argument('-o', '--out_path', type=str, default="", help='Path to store the output files. [Default: Left blank >> If path_phenotypes is provided -> same folder as the path_phenotypes. If not -> Same as the model folder, with GWAS_fullDSV2 subfolder]')
...
def create_conf(args, args4conf, tag=""):
    conf = ConfFile("GWAS/template_noNoise.conf")
