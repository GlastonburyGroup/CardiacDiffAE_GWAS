...
def getARGSParser():
    ...
    parser.add_argument('-n', '--projectName', type=str, default="prova_discovery", help='To be used as the project name for the GWAS and other processed data. [Default: "" (trainID is being used)]')    
    parser.add_argument('-o', '--out_path', type=str, default="/group/glastonbury/GWAS/F20208v3_DiffAE/select_latents_r80", help='Path to store the output files. [Default: Left blank >> If path_phenotypes is provided -> same folder as the path_phenotypes. If not -> Same as the model folder, with GWAS_fullDS~ subfolder]')
