...
def getARGSParser():
    ...
    parser.add_argument('-ph', '--path_phenotypes', type=str, default="/group/glastonbury/emanuele/GWAS/AE_64//values_raw.tsv", help='Path to the phenotype file. [Default: Blank >> They will be generated using the following parameters.]') #If the phenotype file is available, that can directly be provided
    ...
    parser.add_argument('-n', '--projectName', type=str, default="DINOEmbAE64", help='To be used as the project name for the GWAS and other processed data. [Default: "" (trainID is being used)]')    
    ...
    parser.add_argument('-nl', '--nLatents', type=int, default=64, help='Number of latent factors. [Default: 128]')
    ...
    parser.add_argument("-cov", "--covariates", type=str, help="Path to the covariates file", default="/group/glastonbury/emanuele/GWAS/AE_64//covariatesV1.tsv")
    ...
    parser.add_argument("--cov_cols", type=str, help="Coma-seperated list of covarites columns. Leave it blank to use the deafault options. Only if this is supplied, cov_cat_cols and max_cat_levels will be used, and in that case, they are necessary.", default="BIN_Gender,age_at_imaging,age_squared,")
