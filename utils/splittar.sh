...
tar -cvf - /scratch/glastonbury/datasets/ukbbH5s/F20201_Dixon_technique_internal_fat_DICOM_RECOHPipe_H5v3 | pigz -p 16 | split -b 10T - /group/glastonbury/soumick/dataset/ukbbH5s/F20201_Dixon_technique_internal_fat_DICOM_RECOHPipe_H5v3/bkup_megaH5/backup_megaH5_part.