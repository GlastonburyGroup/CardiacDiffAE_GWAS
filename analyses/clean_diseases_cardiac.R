...
option_list = list(
  make_option(c('--root_clinical_data'), action='store', type='character', help='Where the clinical files are storred', default='/project/ukbblatent/Processed_clinical_data/'),
  ...
  make_option(c('--pth_cov_wholecohort'), action='store', type='character', help='Path the covariates TSV file for the whole cohort', default='/group/glastonbury/soumick/PRS/inputs/cov_nonMRI_cohort.tsv'),
  ...
  make_option(c('--root_out'), action='store', type='character', help='', default='/project/ukbblatent/clinicaldata/binary_disease_cohorts/disease_files/'),
