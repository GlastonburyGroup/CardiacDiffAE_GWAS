...
def process_arguments():
    ...
    parser.add_argument('--out_path', action="store", default="/project/ukbblatent/soumick/corr_analyses/F20208v2/v0.9.6_sixth_basket", help="Path to store the results. Make it blank if if it's desired to not store the results, rather just print them on the console.")
    ...
    parser.add_argument('--run_total_corr', action=argparse.BooleanOptionalAction, default=True, help="Whether to run the total correlations (i.e. all vs all).")
    parser.add_argument('--gen_heatmaps_total_corr', action=argparse.BooleanOptionalAction, default=True, help="Whether to generate the heatmaps from the total correlations.")
