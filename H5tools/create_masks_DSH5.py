...
parser.add_argument("--in_path", help="path to store the HDF5 file", default=r"/scratch/glastonbury/datasets/ukbbH5s/_tmp_newV2/F20208_Long_axis_heart_images_DICOM_H5")
