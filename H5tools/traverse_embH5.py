...
if __name__ == "__main__":
    ...
    parser.add_argument("--in_path", help="Path to the HDF5 file of the embeddings", default=r"/group/glastonbury/soumick/LatentWorld/F20208/FactorVAE_latent128.h5")
    parser.add_argument("--out_path", help="Path to the store the embedding CSV. Can leave it blank to store inside the same directory as the HDF5", default=r"/group/glastonbury/soumick/scratch")
